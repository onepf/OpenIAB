...
int main()
{
	...
	s3eOpenIabMapSku(subSkus[0], storeNames->m_GooglePlay, "sku_subs");
   	...
   	s3eOpenIabMapSku(inAppSkus[0], storeNames->m_AppStore, "noncons_1");
   	s3eOpenIabMapSku(inAppSkus[1], storeNames->m_AppStore, "30_real");
   	s3eOpenIabMapSku(subSkus[0], storeNames->m_AppStore, "noncons_2");
