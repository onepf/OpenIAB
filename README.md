...
=====
1. Clone the library ``` git clone https://github.com/onepf/OpenIAB.git``` and link /library as Android Library. Or download the latest released jar from https://github.com/onepf/OpenIAB/releases and attach it to the project.
