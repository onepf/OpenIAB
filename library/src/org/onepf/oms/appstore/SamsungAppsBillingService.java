...
public class SamsungAppsBillingService implements AppstoreInAppBillingService {
    ...
    public Inventory queryInventory(boolean querySkuDetails, List<String> moreItemSkus, List<String> moreSubsSkus) throws IabException {
        ...
        for (String itemGroupId : itemGroupIds) {
            ...
            do {
                itemInbox = null;
                try {
                    if (OpenIabHelper.isDebugEnabled()) Log.d(TAG, "getItemsInbox, startNum = " + startNum + ", endNum = " + endNum);
    ...
    public void launchPurchaseFlow(Activity activity, String sku, String itemType, int requestCode, OnIabPurchaseFinishedListener listener, String extraData) {
        ...
        if (OpenIabHelper.isDebugEnabled()) Log.d(TAG, "launchPurchase: itemGroupId = " + itemGroupId + ", itemId = " + itemId);
        ...
        if (OpenIabHelper.isDebugEnabled()) Log.d(TAG, "Request code: " + requestCode);
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (OpenIabHelper.isDebugEnabled()) Log.d(TAG, "Samsung result code: " + errorCode + ", msg: " + errorMsg);
    ...
    private void initIap() {
        ...
        try {
            ...
            if (result != null) {
                ...
                if (OpenIabHelper.isDebugEnabled()) Log.d(TAG, "Init IAP connection status code: " + statusCode);
