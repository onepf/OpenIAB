...
public class OpenIabHelper {
                ...
                public void onServiceConnected(ComponentName name, IBinder service) {
                    ...
                    try {
                        ...
                        if (appstoreName == null) { // no name - no service
                            ...
                            if (mDebugLog) Log.d(TAG, "discoverOpenStores() add new open store by type: " + openAppstore.getAppstoreName());
                            synchronized (result) {
    ...
    protected List<Appstore> inventoryCheck(final List<Appstore> availableStores) {
        ...
        try {
            ...
            if (mDebugLog) Log.e(TAG, "selectBillingService()  inventory check is failed. candidates: " + candidates.size()
    ...
    protected Appstore selectBillingService(final List<Appstore> availableStores) {
        ...
        try {
            ...
            if (mDebugLog) Log.e(TAG, "Are we installed?", e);
        }
